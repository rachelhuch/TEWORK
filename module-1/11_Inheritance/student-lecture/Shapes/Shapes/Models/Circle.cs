...
namespace Shapes.Models
{
    ...
    {
        //make sure to inherit shape properties etc
        public int Radius { get; set; }
        public override int Area
        {
            get
            {
                return (int)(Math.PI * Radius * Radius); //do math first then cast to an int
            }
        }
        ...
        {
        return $"A {Color} Circle with radius {Radius}, {(IsFilled} ? "" :" not")}";//ternary
    }
}
}
